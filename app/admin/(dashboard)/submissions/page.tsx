...
import { Loader2, Mail, Plane, Users, Calendar, Phone, MessageSquare, Trash2 } from "lucide-react";
                                ...
                                <tr key={sub._id} className="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="max-w-xs">
                                            {sub.destinationName && (
                                                <div className="mb-2">
                                                    <span className="px-2 py-0.5 bg-[#151794] text-white text-[10px] font-bold rounded-full uppercase tracking-wider">
                                                        {sub.destinationName}
                                                    </span>
                                                </div>
                                            )}
