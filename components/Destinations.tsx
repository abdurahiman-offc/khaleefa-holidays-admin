...
export default function Destinations() {
    ...
    if (loading) {
        return (
            <section id="destinations" className="py-24 bg-white flex items-center justify-center">
        ...
        <section id="destinations" className="pt-[100px] pb-7 md:pb-[100px] bg-[#151794] relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 pt-10">
                                ...
                                {destinations.map((place, index) => (
                                    ...
                                    >
                                        <div className="relative aspect-[4/3] overflow-hidden">
                                            <Image
                                                src={place.image}
                                                alt={`${place.name} - Exploring the best destinations with Khaleefa Holidays`}
                                                fill
                            ...
                            {destinations.map((place, index) => (
                                ...
                                >
                                    <div className="relative aspect-[4/3] overflow-hidden">
                                        <Image
                                            src={place.image}
                                            alt={`${place.name} - Premium Travel Experience`}
                                            fill
                                            className="object-cover transition-transform duration-700 group-hover:scale-110"
                                        />
                                        <div className="absolute inset-0 bg-black/10 group-hover:bg-black/0 transition-colors duration-300" />
                ...
                <div className="md:hidden">
                    <div
                        className="flex overflow-x-auto gap-4 pb-8 snap-x snap-mandatory scrollbar-hide px-4 justify-center"
                        style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
                    >
                        {destinations.map((place, index) => (
                            <motion.div
                                ...
                                transition={{ duration: 0.4, delay: index * 0.05 }}
                                onClick={() => setSelectedId(place._id)}
                                className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm border-[3px] border-slate-100 group hover:shadow-xl transition-shadow duration-300 flex-shrink-0 snap-center w-[72vw]"
                            >
                                <div className="relative aspect-[4/3] overflow-hidden">
                                    <Image
                                        src={place.image}
                                        alt={`${place.name} Holiday Package`}
                                        fill
                                        className="object-cover transition-transform duration-700 group-hover:scale-110"
                                    />
                                    <div className="absolute inset-0 bg-black/10 group-hover:bg-black/0 transition-colors duration-300" />
        ...
        <div className="flex flex-col md:flex-row w-full relative overflow-y-auto md:overflow-hidden bg-white md:rounded-3xl scrollbar-hide">
            ...
            <div className="w-full md:w-2/3 p-4 md:p-10 flex flex-col border-b-2 md:border-b-0 md:border-r-2 border-dashed border-slate-200 md:overflow-y-auto scrollbar-hide h-auto">
                ...
                <div className="relative rounded-3xl overflow-hidden aspect-[16/9] mb-8 group shrink-0">
                    <img src={place.image} alt={`${place.name} Gallery - Khaleefa Holidays`} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            ...
            <div className="w-full md:w-1/3 bg-slate-50 p-6 md:p-10 flex flex-col md:overflow-y-auto scrollbar-hide h-auto">
                <div className="mb-6">
                    <p className="text-[10px] font-black text-slate-400 tracking-[0.2em] uppercase mb-1">Service Info</p>
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-4 px-1">
                        <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                            ...
                            <span className="font-extrabold text-[#151794] text-base">{place.price}</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Duration</span>
                            <span className="font-extrabold text-slate-600 text-sm uppercase">{place.duration || "5 Days"}</span>
                        </div>
                    </div>
                </div>
